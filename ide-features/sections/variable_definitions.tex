...
The \textbf{Audience} of an \gls{ide} refers generally to the target
populations for which the \gls{ide} is developed.
...
\begin{AlignedDesc}
  ...
  \item[Description] The \textbf{Domain} of an \gls{ide} refers to the
  ...
  \begin{AlignedDesc}
    \item[General] This \gls{ide} is general purpose. It can be applied to
...
\begin{AlignedDesc}
  ...
  \item[Description] The \textbf{Skill Level} of an \gls{ide} describes what
...
The \textbf{Chrome} of an \gls{ide} is the sum total of user interface
...
\begin{AlignedDesc}
  ...
  \item[Description] Many \glspl{ide} provide support for a set of common
  operations. \citeauthor{murphy2006} define a list of the top 10 most
  frequently used \gls{ide} features, which are reproduced here as boolean
  sub-variables. \cite{murphy2006} Each sub-variable indicates whether the
  \gls{ide} in question supports the use of that particular feature.
...
\begin{AlignedDesc}
  ...
  \begin{AlignedDesc}
    \item[Yes] The \gls{ide} supports context sensitive tools.
    \item[No] The \gls{ide} does not support context sensitive tools.
  \end{AlignedDesc}
...
\begin{AlignedDesc}
  ...
  tools, components, or actions that the \gls{ide} offers to the user. If an
  \gls{ide} employs a \textbf{Searchable Toolspace}, it allows the user to
  search through this toolspace by name or keywords.

  \item[Accepted Values]

  \begin{AlignedDesc}
    \item[Yes] The \gls{ide} supports a searchable toolspace.
    \item[No] The \gls{ide} does not support a searchable toolspace.
  \end{AlignedDesc}
...
\begin{AlignedDesc}
  ...
  workspace provided by the \gls{ide}. If the \gls{ide} offers no method for
  tool organization or if there is an immense amount of tools visible at
  once, then the \gls{ide} is likely visually cluttered.
...
\textbf{Human Interface} components of an \gls{ide} include aspects of the
interface that describe how a human user interfaces with the \gls{ide},
...
\begin{AlignedDesc}
  ...
  \item[Description] The \textbf{Essential Efficiency} of an \gls{ide}
...
\begin{AlignedDesc}
  ...
  \item[Description] The \textbf{Interface Efficiency} of an \gls{ide} is a
...
\begin{AlignedDesc}
  ...
  \gls{ide} utilizes the use of a keyboard.  This can range from a complete
  ...
  \begin{AlignedDesc}
    \item[None] The \gls{ide} does not offer the use of a keyboard.
...
\begin{AlignedDesc}
  ...
  given \gls{ide}.  The \textit{Drag n Drop} process refers to a single
...
\begin{AlignedDesc}
  ...
  \begin{AlignedDesc}
    \item[None] The \gls{ide} does not offer any functionality for
...
\begin{AlignedDesc}
  ...
  \item[Description] This refers to an \gls{ide}'s ability to emphasize
  ...
  \begin{AlignedDesc}
    \item[Yes] The \gls{ide} emphasizes the allowed relations.
    \item[No] The \gls{ide} does not emphasize the allowed relations.
  \end{AlignedDesc}
...
\begin{AlignedDesc}
  ...
  \item[Description] Given an \gls{ide}'s
