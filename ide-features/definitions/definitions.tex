...
\begin{AlignedDesc}
  ...
  Appendix~\ref{app:euc}). This measure is sometimes referred to as
  \textit{Essential Efficiency}. \cite{constantine1996}
%
  \begin{align*}
...
\begin{AlignedDesc}
  ...
  \item[Description] The \textbf{Essential Efficiency} of an \ac{ide} is a
...
%
  ...
  instead of concrete task requirements.
