...
Create Element (\ref{app:euc_create}) & {\color{red}0} & {\color{red}0} \\
Create and Link Elements (\ref{app:euc_create_link}) & {\color{red}0} & {\color{red}0}
\end{tabularx}
%}}}
...
Create Element (\ref{app:euc_create})                & 0 & 0 \\
Create and Link Elements (\ref{app:euc_create_link}) & 0 & 0
\end{tabularx}
%}}}
