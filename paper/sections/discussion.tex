...
%A single perspective, as is most common among sampled \acp{ide}, indicates
%a single level of user control as well as a visually and mentally simple
%design paradigm.
...
%But around four distinct variables, the common theme in the sampled
%\acp{ide}, might be enough to discriminate tools and yet not too much to
%become junk.
...
Some \ac{ide} features can be related to one another. The collected data
...
%features, is a starting point for future work in the field. As discussed
%in the conclusion, further analytical work using the reported data as well
%as any expanded data set must be performed to fully understand the scope
%of this feature set's impact on usability and suitability.
