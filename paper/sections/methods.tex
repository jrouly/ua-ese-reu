...
Thus this survey considers \acp{ide} from eight different domains: 3D modeling, animation, modeling, music, prototyping, simulation, software\es{more precisely (education, mobile dev, etc.)}, and workflow\es{in the sense of business workflows?}.
...
\es{Explain what use cases were used}
The
