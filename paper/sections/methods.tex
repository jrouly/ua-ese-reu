...
\Fig{fig:featuremodel} is a feature model describing the features we considered for the visual \acp{ide}.
...
%\begin{figure}
%  \centering
%  \includegraphics[width=\linewidth]{images/ide_feature_model}
